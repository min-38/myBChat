            ...
            <form action="#!" onSubmit={(e) => handleSubmit(e)}>
                ...
                <div className="form-group">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                    />
                    <span className="valid_msg"></span>
                </div>
                <div className="form-group">
                    <label htmlFor="password" className="sr-only">Password <span className="RequiredInput">*</span></label>
                    <input
                        type="password"
                        id="password"
                        className="form-control"
                ...
                <div className="form-group">
                    <label htmlFor="password_confirm" className="sr-only">Password Confirm <span className="RequiredInput">*</span></label>
                    <input
                        type="password"
                        id="password_confirm"
                        className="form-control"
